...
class MyGUI:
    ...
    # i.e. deleteing a user, updating notice board and even viewing the attendance of all registred students
    @staticmethod
    def justadminThings(num,adminroot):
        ...
        if(num==1):
            ...
            lbl=Label(newadminFrame,text="Registered users",bg="orange",font=('Times',15,'bold'))
            lbl.pack()
    ...
    def sureDelete(newadminroot,newadminFrame,firstNameEntry,lastNameEntry,usernameEntry,prnEntry):
        ...
        yes = Button(newframe,text="Yes",bg="yellow",activebackground="red",font=('Times',15,'bold italic'),command=lambda:gui.deleteUser(newframe,newadminroot,newadminFrame,firstNameEntry,lastNameEntry,usernameEntry,prnEntry))
        yes.pack(side=LEFT,padx=40)
        
        no=Button(newframe,text="No",bg="yellow",activebackground="red",font=('Times',15,'bold italic'),command=lambda: gui.justadminThings(1,newadminroot))
